        ...
        <Layout>
            <Head>
                <meta name="description"
                      content="Keuken wrappen in Almere of omgeving? Wij geven je keuken een nieuwe uitstraling! ✓ 6 jaar garantie ✓ Vakkundig & professioneel ✓ Neem contact op!"/>
                <meta name="keywords" content={`Keuken wrappen, Keuken wrappen Almere}`}/>
                <title>Keuken wrappen Almere | In 1 dag klaar! | Wrapjekeuken.nl</title>
                <link rel="icon" href="/favicon.png"/>
            </Head>
            <Breadcrump/>
            <div className="grid lg:grid-cols-4 grid-cols-1 xl:container mx-auto px-6">
                <div className="col-span-3 xl:pl-6 mt-12">
                    <h1 className="text-2xl font-bold">Keuken wrappen in Almere</h1>
                    <div className="w-20 h-05 wrap-bg mt-5"/>
                    <p className="mt-5 text-sm">
                        Je keuken is één van de gezelligste plekken in je woning, waar je optimaal hoort te
                        genieten. Niet alleen wordt er gekookt en lekker gegeten, maar ook een borrel of een
                        gezellige spelletjesavond vinden meestal plaats in de keuken.
                    </p>
                    <p className="mt-5 text-sm">
                        Wil je graag een nieuwe keuken, maar is je huidige keuken kwalitatief nog goed? Laat
                        dan je keuken wrappen! Zo geef je je keuken een volledig nieuwe uitstraling, zonder
                        dat je dagenlang in een verbouwing zit óf dat je de hoofdprijs moet betalen.
                    </p>
                    <h2 className="font-bold text-lg mt-5">Keuken verbouwen of keukenkastjes vernieuwen?</h2>
                    <div className="w-20 h-05 wrap-bg mt-5"/>
                    <p className="mt-5 text-sm">
                        Als je keuken nog in goede staat is en je de apparatuur nog heel goed een paar jaar
                        kunt gebruiken, is het zonde om je volledige keuken te verbouwen. Niet alleen
                        financieel gezien, maar ook in verband met de troep en onrust die een verbouwing
                        met zich meebrengt.
                    </p>
                    <p className="mt-5 text-sm">
                        Onze professionele wrappers zorgen ervoor dat je binnen één dag weer kunt
                        genieten van het gevoel van een nieuwe keuken! Ons team wrapt al je keukenkastjes
                        en, indien gewenst, ook je keukenblad. Passen de frontjes van je kastdeurtjes niet
                        meer bij de nieuwe kleur van je keukenkastjes? Geen probleem! Wij helpen je graag
                        aan nieuwe frontjes die volledig passen bij jouw smaak en interieur.
                    </p>
                    <p className="mt-5 text-sm">
                        Inspiratie opdoen of benieuwd naar ons werk? Bekijk onze <Link href="/projecten">
                        <a className="text-three underline">opgeleverde projecten</a></Link> en volg ons op <a
                        className="text-three" href="https://www.instagram.com/wrapjekeuken.nl">Instagram!</a>
                    </p>
                    <div
                    ...
                    <p className="mt-5 text-sm">
                        ...
                        onze <Link href="/projecten"><a className="text-three underline">gerealiseerde
                        projecten</a></Link> en volg ons op <a className="text-three"
                                                               href="https://www.instagram.com/wrapjekeuken.nl">Instagram</a> om
                        de indrukwekkende
                    ...
                    <div className="diensten__kosten mt-12 bg-gray-100 p-12 mb-12 pr-6 lg:mx-0 mx-6">
                        ...
                        <p className="mt-5 text-sm">
                            Neem <Link href="/contact"><a className="text-three underline">contact</a></Link> met ons op
                            en geniet binnenkort ook van een nieuwe keuken! Stuur
